                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{moment(n.paymentDate).format('DD MMMM YYYY hh:mm a')}</TableCell>
                      <TableCell align="right">{n.status}</TableCell>
                      <TableCell align="right">{n.description}</TableCell>
                      <TableCell align="right">{`L ${n.amount.toLocaleString(navigator.language, { minimumFractionDigits: 2 })}`}</TableCell>
                      <TableCell align="right">{`${n.firstName} ${n.lastName}`}</TableCell>
                      <TableCell align="right">{moment(n.createdAt).format('DD MMMM YYYY hh:mm a')}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
